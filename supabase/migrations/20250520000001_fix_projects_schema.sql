/*
  ...
  This migration fixes the projects table schema to ensure all required columns exist
  and the table structure is consistent with the application code.

  Issues Fixed:
  1. Schema inconsistency between migrations
  2. Replace tags column with tech_stack column
  3. Ensure proper table structure without image_url
*/
